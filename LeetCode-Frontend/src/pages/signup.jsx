g// import { useForm } from 'react-hook-form';
...
//         if (isAuthenticated) {
//             navigate('/');
//             console.log("Navigate to home page through singup")
//         }
...
//         {
//             icon: "📬",
//             title: "Real-time OTP & Mail Verification",
//             desc: "Email verification and OTP support powered by real-time mail delivery for secure signups."
//         },
//         {
//             icon: "🔑",
//             title: "Forgot Password Flow",
//             desc: "Full forgot password support with expiring reset tokens sent directly to your email."
//         },
//         {
//             icon: "🛡️",
//             title: "Separate Admin & User Panel",
//             desc: "Role-based access control with dedicated admin panel for platform management."
//         },
//     ];
...
//                         CodeIt is a production-grade competitive coding platform with enterprise-level auth infrastructure — not a toy project.
//                     </p>
...
//                             />
//                             {errors.firstName && (
//                                 <p className="mt-1.5 text-[11px] text-[#ff453a]">⚠ {errors.firstName.message}</p>
//                             )}
//                         </div>
...
//                         <Link to="/login" className="text-[#98989d] hover:text-white transition-colors duration-200">
//                             Sign in
//                         </Link>
//                     </p>
